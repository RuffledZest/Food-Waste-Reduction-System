function ChooseRole() {
    return <div id="join">
        ...
        <section className="p-24 grid grid-cols-2 place-items-center">
            <div className="relative overflow-hidden w-80 h-96 rounded-3xl shadow-2xl cursor-pointer text-2xl font-bold bg-center bg-cover bg-[url('/assets/donator.jpg')]">
                ...
                <h1 className="p-3 text-4xl bg-gradient-to-r from-white via-blue-500 to-white  inline-block text-transparent bg-clip-text">Join Us!</h1>
            ...
            <div className="relative overflow-hidden w-80 h-96 rounded-3xl shadow-2xl cursor-pointer text-2xl font-bold bg-center bg-cover bg-[url('/assets/receiver.jpg')]">
                <div className="z-10 absolute w-full h-full peer"></div>
                <div className="absolute peer-hover:-top-20 peer-hover:-left-16 peer-hover:w-[140%] peer-hover:h-[140%] -top-32 -left-16 w-32 h-44 rounded-full bg-transparent backdrop-blur-sm bg-emerald-300 transition-all duration-500"></div>
                <div className="absolute flex flex-col text-xl text-center items-end justify-end peer-hover:right-0 peer-hover:rounded-b-none peer-hover:bottom-0 peer-hover:items-center peer-hover:justify-center peer-hover:w-full peer-hover:h-full -bottom-32 -right-16 w-36 h-44 rounded-full bg-transparent backdrop-blur-md transition-all duration-500">
                    <h1 className="p-3 text-4xl  bg-gradient-to-r from-red-900 via-rose-500 to-amber-600 inline-block text-transparent bg-clip-text">Join Us!</h1>
